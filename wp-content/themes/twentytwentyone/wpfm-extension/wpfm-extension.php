    ...
    <script>
        ...
        jQuery(function () {
            ...
            jQuery('#add_menu_item').on('click', function () {
                ...
                jQuery("#add-new-cate-form").children(".required").each(function () {
                    //debugger;
                ...
                <div class="row ml-0 mr-0">
                    <div class="col-md-12">
                        <div class="field-holder">
                            ...
                            <span><input type="checkbox" name="nutritional_information[]" id="banana" value="banana" class="required"/>Banana</span>
                            <label><input type="checkbox" name="nutritional_information[]" id="egg" value="egg" class="required"/>Egg</label>
                            <label><input type="checkbox" name="nutritional_information[]" id="garlic" value="garlic" class="required"/>Garlic</label>
                            <label><input type="checkbox" name="nutritional_information[]" id="chilli" value="chilli" class="required"/>Chilli</label>
                        </div>
                    </div>                                          
                </div>
